// ******************************************************************************************
// ****************************** CODE.GS (BACKEND) *****************************************
// Version 1.16.0 - v274: MAJ VLI + SAC ISP (Penthrox, Kétoprofène, sacoche rouge, DIO, pochette droite, sac réserve)
// ******************************************************************************************
...
function getData() {
  try {
    ...
    // v274: Update VLI + SAC ISP content (Penthrox, Kétoprofène, sacoche rouge, DIO, pochette droite, sac réserve)
    if (!SCRIPT_PROP.getProperty("INIT_V12_VLI_SAC_ISP_UPDATE")) {
      initVLIContent_();
      let f12_ = {};
...
function getSacISPContent_() {
  return [
    { section: "Sac ISP", position: "Sac ISP", items: [
      ...
      { name: "Penthrox", type: "nombre", def: "1", subsection: "Intérieur du sac" },
      { name: "Kétoprofène", type: "nombre", def: "1", subsection: "Intérieur du sac" },
      ...
      { name: "Ciseaux", type: "nombre", def: "1", subsection: "Pochette jaune" },
      { name: "Seringue 10cc", type: "nombre", def: "1", subsection: "Pochette jaune" },
      ...
      { name: "Manche laryngo monté et lame n°4 ou 3", type: "nombre", def: "1", subsection: "Sacoche rouge" },
      { name: "Tube laryngé pédiatrique + cale dents + seringue", type: "nombre", def: "1", subsection: "Sacoche rouge" },
      { name: "Tube laryngé T4 + cale dents + seringue", type: "nombre", def: "1", subsection: "Sacoche rouge" },
      { name: "Piles de rechange", type: "nombre", def: "2", subsection: "Sacoche rouge" },
...
function getVLIContent_() {
  return [
    ...
    { section: "Sac Réserve", position: "Sac Réserve", items: [
      ...
      { name: "Glucosé 5% 500ml", type: "nombre", def: "1", subsection: "" },
      { name: "Medinette", type: "nombre", def: "1", subsection: "" },
      { name: "Kit aspi", type: "nombre", def: "1", subsection: "" },
      { name: "Pochette petit matériel (2 valves anti retour; 2 seringue 10cc, 2 trocards, 2 bouchons, 1 perfuseur, 1 opsite)", type: "nombre", def: "1", subsection: "" }
    ]},
